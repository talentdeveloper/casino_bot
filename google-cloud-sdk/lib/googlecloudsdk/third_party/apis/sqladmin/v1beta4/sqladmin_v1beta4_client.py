...
class SqladminV1beta4(base_api.BaseApiClient):
  ...
  class InstancesService(base_api.BaseApiService):
    ...
    def DemoteMain(self, request, global_params=None):
      """Demotes the standalone instance to be a read replica Cloud SQL instance of an on-premises main.
    ...
    DemoteMain.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'instance', u'project'],
        query_params=[],
        relative_path=u'projects/{project}/instances/{instance}/demoteMain',
